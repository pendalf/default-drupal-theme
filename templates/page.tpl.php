...
<footer id="footer">
  ...
  <div class="section__inner clearfix"><div class="section__inner--cols">
    ...
    <?php if ($page['footer_firstcolumn'] || $page['footer_secondcolumn'] || $page['footer_thirdcolumn']) : ?>
        ...
        <?php if ($page['footer_firstcolumn']): ?><div class="footer_firstcolumn"><?php print render($page['footer_firstcolumn']); ?></div><?php endif; ?>
        <?php if ($page['footer_secondcolumn']): ?><div class="footer_secondcolumn"><?php print render($page['footer_secondcolumn']); ?></div><?php endif; ?>
        <?php if ($page['footer_thirdcolumn']): ?><div class="footer_thirdcolumn"><?php print render($page['footer_thirdcolumn']); ?></div><?php endif; ?>
...
<?php if ($page['drop_menu']) { 
  ...
  print '<div class="slidebar">';
  print '<div class="slidebar__close"></div>';
  print '<div class="slidebar__content">';
  // print '<a href="' . $front_page . '" title="' . t('Home') . '" rel="home" id="logo-drop">';
  // print '<img src="' . path_to_theme() . '/img/logo__drop.png" alt="' . t('Home') . '" />';
  // print '</a>';
  print  render($page['drop_menu']) . '</div></div></div>';
}?>
